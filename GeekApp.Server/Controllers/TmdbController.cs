...
namespace GeekApp.Server.Controllers
{
    ...
    public class TmdbController : ControllerBase
    {
        ...
        [HttpGet("summary/{mediaType}/{id}")]
        public async Task<ActionResult<TmdbResult>> GetTitleSummary(string mediaType, int id)
        {
            try
            {
            ...
            {
                return StatusCode(500, $"Failed to fetch TMDB summary: {ex.Message}");
            }
        }
    }
}